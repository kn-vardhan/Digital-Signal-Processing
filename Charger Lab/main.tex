...
\section{Results}
The screenshot of the voltage of the charger with Volt-meter.
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{figs/voltmeter.jpeg}
    \caption{Screenshot of the voltage of the charger with Volt-meter.}
    \label{fig:voltmeter}
\end{figure}
